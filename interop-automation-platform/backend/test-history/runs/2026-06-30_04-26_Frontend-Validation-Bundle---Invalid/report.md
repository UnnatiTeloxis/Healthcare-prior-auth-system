...
**Status:** FAIL
**Timestamp:** 2026-06-30T04:26:44
**Run ID:** `2026-06-30_04-26_Frontend-Validation-Bundle---Invalid`

## Summary

Validation failed with 29 error(s) | Invalid values in: Bundle.entry[0], Bundle.entry[7].resource/*Patient/doc-patient-bad*/.gender, Bundle.entry[8]
...
| IssueSeverity.error | Bundle.entry[4].resource/*MedicationStatement/doc-med-001*/.medication.ofType(CodeableConcept).coding[0] | java.net.SocketTimeoutException: timeout |
...
| IssueSeverity.information | Bundle.entry[6].resource/*Observation/doc-obs-wbc*/.value.ofType(Quantity) | Reference to draft CodeSystem http://unitsofmeasure.org\|2.1.1 |
| IssueSeverity.information | Bundle.entry[5].resource/*DiagnosticReport/doc-report-001*/.code | None of the codings provided are in the value set 'LOINC Diagnostic Report Codes' (http://hl7.org/fhir/ValueSet/report-codes\|4.0.1), and a coding is recommended to come from this value set (codes = http://loinc.org#58410-2) |
| IssueSeverity.warning | Bundle.entry[0].resource/*Composition/composition-root-001*/.section[0].code.coding[0].display | Wrong Display Name 'Problem list' for http://loinc.org#11450-4. Valid display is 'Problem list - Reported' (en) (for the language(s) 'en') |
| IssueSeverity.warning | Bundle.entry[0].resource/*Composition/composition-root-001*/.section[1].code.coding[0].display | Wrong Display Name 'History of Medication use' for http://loinc.org#10160-0. Valid display is 'History of Medication use Narrative' (en) (for the language(s) 'en') |
| IssueSeverity.warning | Bundle.entry[0].resource/*Composition/composition-root-001*/.section[2].code.coding[0].display | Wrong Display Name 'Relevant diagnostic tests/laboratory data' for http://loinc.org#30954-2. Valid display is 'Relevant diagnostic tests/laboratory data note' (en) (for the language(s) 'en') |
| IssueSeverity.warning | Bundle.entry[5].resource/*DiagnosticReport/doc-report-001*/.code.coding[0].display | Wrong Display Name 'CBC panel' for http://loinc.org#58410-2. Valid display is 'CBC panel - Blood by Automated count' (en) (for the language(s) 'en') |
...
| IssueSeverity.warning | Bundle.entry[6].resource/*Observation/doc-obs-wbc*/.code.coding[0].display | Wrong Display Name 'Leukocytes [#/volume] in Blood' for http://loinc.org#6690-2. Valid display is 'Leukocytes [#/volume] in Blood by Automated count' (en) (for the language(s) 'en') |
