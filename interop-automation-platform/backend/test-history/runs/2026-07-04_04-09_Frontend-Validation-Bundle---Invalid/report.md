...
**Run ID:** `2026-07-04_04-09_Frontend-Validation-Bundle---Invalid`
...
|----------|----------|---------|
| IssueSeverity.error | Bundle.entry[2].resource/*Observation/stress-obs-height*/.code.coding[0] | java.net.SocketTimeoutException: timeout |
...
| IssueSeverity.warning | Bundle.entry[2].resource/*Observation/stress-obs-height*/.value.ofType(Quantity) | java.net.SocketTimeoutException: timeout |
| IssueSeverity.warning | Bundle.entry[3].resource/*Observation/stress-obs-glucose*/.value.ofType(Quantity) | java.net.SocketTimeoutException: timeout |
